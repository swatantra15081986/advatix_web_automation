...
function addScreenshots() {
  if (!fs.existsSync(screenshotsDir)) {
    console.warn(chalk.yellow(`WARNING: Folder './${screenshotsDir}' not found. REPORT WILL BE GENERATED WITHOUT SCREENSHOTS!`))
  } else {  
...
function generateReport() {
 if (!fs.existsSync(cucumberJsonDir)) {
   ...
   report.generate({
     ...
     pageTitle: 'LOGISTICS FRONTEND AUTOMATION REPORT',
     reportName: `LOGISTICS FRONTEND AUTOMATION REPORT - ${new Date().toLocaleString()}`,
     hideMetadata: true
   })
 }
}